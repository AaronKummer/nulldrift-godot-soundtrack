...
const DEFS := {
	"sewer": {
		...
		"enemies": {
			"rat": { "sheet": "cat", "hp": 1, "speed": 115.0, "size": 12.0,
				"dmg": 5, "credits": 3, "tint": Color(0.5, 1.4, 0.55), "scale": 0.7 },
			"ganger": { "sheet": "ninja", "hp": 4, "speed": 78.0, "size": 16.0,
				"dmg": 9, "credits": 8, "tint": Color(0.55, 1.4, 0.6), "scale": 1.0 },
			"mutant": { "sheet": "thug", "hp": 7, "speed": 46.0, "size": 19.0,
				"dmg": 13, "credits": 12, "tint": Color(0.45, 1.3, 0.5), "scale": 1.1 },
		},
		"grate_pool": ["rat", "rat", "ganger", "ganger", "mutant"],
		"hole_pool": ["rat"],
