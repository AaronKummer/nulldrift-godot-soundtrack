...
const DEFS := {
	...
	# ── THE FINALE — VVS TOWER ────────────────────────────────────────────
	# The violet spire that dominates the skyline. A vertical gauntlet of
	# corporate elite security, floor by floor, up to the two-phase boss:
	# the VIOLET DRAGON, who on defeat reveals LEON TUSK. Beating Tusk ends
	# the game (the walk-away / merge choice). Floors set to 6 for a real
	# climb without slog — bump toward the canon 12 once it's tuned.
	"vvs": {
		"name": "VVS TOWER",
		"exit_label": "back down to the street",
		"exit_scene": "street_financial",
		"exit_spawn": "from_vvs",
		"floors": 6,
		"grid_w": 23, "grid_h": 19,
		"rooms": 7, "room_min": 4, "room_max": 6,
		"water_room_chance": 0.0,
		"flavor_chance": 0.35,
		"on_defeat": "vvs_ending",
		"floor_names": ["LOBBY ATRIUM", "TRADING FLOOR", "SERVER VAULT",
			"EXECUTIVE SUITES", "SPIRE APPROACH", "THE PENTHOUSE"],
		"floor_pools": [
			["vvs_guard", "vvs_guard", "vvs_drone"],
			["vvs_guard", "vvs_ninja", "vvs_drone"],
			["vvs_ninja", "vvs_enforcer"],
			["vvs_enforcer", "vvs_mech", "vvs_drone"],
			["vvs_ninja", "vvs_enforcer", "vvs_mech"],
			["vvs_mech", "vvs_enforcer"],
		],
		"floor_pals": [
			{ "floor": Color(0.08, 0.06, 0.12), "floor_flavor": Color(0.14, 0.07, 0.18),
			  "wall": Color(0.14, 0.09, 0.18), "wall_rim": Color(0.40, 0.22, 0.55),
			  "water": Color(0.06, 0.04, 0.12), "water_shine": Color(0.5, 0.3, 0.8),
			  "bridge": Color(0.20, 0.14, 0.26), "sconce": Color(1.0, 0.45, 1.4),
			  "flavor_light": Color(0.8, 0.4, 1.4), "accent": Color(0.9, 0.4, 1.4),
			  "conduit": Color(0.8, 0.4, 1.4) },
			{ "floor": Color(0.09, 0.06, 0.13), "floor_flavor": Color(0.15, 0.08, 0.20),
			  "wall": Color(0.15, 0.09, 0.20), "wall_rim": Color(0.46, 0.23, 0.62),
			  "water": Color(0.06, 0.04, 0.12), "water_shine": Color(0.5, 0.3, 0.8),
			  "bridge": Color(0.20, 0.14, 0.26), "sconce": Color(1.1, 0.46, 1.45),
			  "flavor_light": Color(0.8, 0.4, 1.4), "accent": Color(0.9, 0.38, 1.4),
			  "conduit": Color(0.8, 0.4, 1.4) },
			{ "floor": Color(0.10, 0.06, 0.14), "floor_flavor": Color(0.16, 0.08, 0.21),
			  "wall": Color(0.16, 0.10, 0.22), "wall_rim": Color(0.52, 0.24, 0.68),
			  "water": Color(0.06, 0.04, 0.12), "water_shine": Color(0.5, 0.3, 0.8),
			  "bridge": Color(0.21, 0.14, 0.27), "sconce": Color(1.2, 0.47, 1.5),
			  "flavor_light": Color(0.8, 0.4, 1.4), "accent": Color(0.9, 0.36, 1.4),
			  "conduit": Color(0.85, 0.4, 1.4) },
			{ "floor": Color(0.11, 0.06, 0.15), "floor_flavor": Color(0.17, 0.09, 0.22),
			  "wall": Color(0.17, 0.10, 0.24), "wall_rim": Color(0.58, 0.25, 0.74),
			  "water": Color(0.06, 0.04, 0.12), "water_shine": Color(0.5, 0.3, 0.8),
			  "bridge": Color(0.22, 0.15, 0.28), "sconce": Color(1.3, 0.48, 1.55),
			  "flavor_light": Color(0.85, 0.4, 1.45), "accent": Color(0.95, 0.34, 1.45),
			  "conduit": Color(0.85, 0.4, 1.45) },
			{ "floor": Color(0.12, 0.06, 0.16), "floor_flavor": Color(0.18, 0.09, 0.24),
			  "wall": Color(0.18, 0.11, 0.26), "wall_rim": Color(0.64, 0.26, 0.82),
			  "water": Color(0.06, 0.04, 0.12), "water_shine": Color(0.5, 0.3, 0.8),
			  "bridge": Color(0.23, 0.15, 0.30), "sconce": Color(1.4, 0.5, 1.6),
			  "flavor_light": Color(0.9, 0.4, 1.5), "accent": Color(1.0, 0.32, 1.5),
			  "conduit": Color(0.9, 0.4, 1.5) },
			# THE PENTHOUSE — hottest violet, the Dragon's lair
			{ "floor": Color(0.14, 0.06, 0.18), "floor_flavor": Color(0.20, 0.09, 0.26),
			  "wall": Color(0.20, 0.11, 0.28), "wall_rim": Color(0.72, 0.28, 0.92),
			  "water": Color(0.06, 0.04, 0.12), "water_shine": Color(0.6, 0.3, 0.9),
			  "bridge": Color(0.24, 0.16, 0.32), "sconce": Color(1.5, 0.5, 1.7),
			  "flavor_light": Color(1.0, 0.4, 1.6), "accent": Color(1.1, 0.3, 1.6),
			  "conduit": Color(1.0, 0.4, 1.6) },
		],
		"pal": {
			"floor": Color(0.10, 0.07, 0.14), "floor_flavor": Color(0.14, 0.08, 0.18),
			"wall": Color(0.15, 0.10, 0.20), "wall_rim": Color(0.45, 0.25, 0.60),
			"water": Color(0.06, 0.04, 0.12), "water_shine": Color(0.5, 0.3, 0.8),
			"bridge": Color(0.20, 0.14, 0.26), "sconce": Color(1.1, 0.5, 1.5),
			"flavor_light": Color(0.8, 0.4, 1.4), "accent": Color(0.9, 0.4, 1.4),
			"conduit": Color(0.8, 0.4, 1.4),
		},
		"enemies": {
			"vvs_guard": { "sheet": "thug", "hp": 12, "speed": 58.0, "size": 19.0,
				"dmg": 11, "credits": 30, "tint": Color(0.9, 0.7, 1.2), "scale": 1.05,
				"shoot": { "range": 360.0, "cd": 1.6, "dmg": 10, "keep": 240.0 } },
			"vvs_drone": { "sheet": "cat", "hp": 5, "speed": 155.0, "size": 12.0,
				"dmg": 8, "credits": 12, "tint": Color(1.0, 0.6, 1.3), "scale": 0.85,
				"drops": false },
			"vvs_ninja": { "sheet": "ninja", "hp": 14, "speed": 92.0, "size": 18.0,
				"dmg": 15, "credits": 45, "tint": Color(0.8, 0.6, 1.2), "scale": 1.0,
				"lunge": true },
			"vvs_enforcer": { "sheet": "yak3", "hp": 22, "speed": 62.0, "size": 21.0,
				"dmg": 14, "credits": 70, "tint": Color(1.0, 0.75, 1.3), "scale": 1.15,
				"shoot": { "range": 400.0, "cd": 1.3, "dmg": 12, "keep": 260.0 } },
			"vvs_mech": { "sheet": "troll", "hp": 34, "speed": 48.0, "size": 24.0,
				"dmg": 20, "credits": 90, "tint": Color(0.9, 0.5, 1.2), "scale": 1.35,
				"lunge": true },
		},
		"grate_pool": ["vvs_ninja", "vvs_drone"],
		"hole_pool": ["vvs_drone", "vvs_guard"],
		"grates": 4, "rat_holes": 3, "chests": 4,
		"medkits_min": 3, "medkits_max": 6,
		"stash_credits": 1500,
		"objective_prop": "relay",
		"objective_flag": "vvsCoreWiped",
		"objective_credits": 800,
		"seal_reward": 40, "seal_all_reward": 600,
		# TWO-PHASE FINALE BOSS. Phase 1 = the VIOLET DRAGON (a hovering combat
		# frame: spray + summon + charge). At 0 HP it doesn't die — the cockpit
		# splits and LEON TUSK steps out for phase 2: a faster duelist, charge +
		# tight spray, no summons. Down Tusk and the game ends.
		"boss": {
			"name": "VIOLET DRAGON", "sheet": "troll", "hp": 170, "speed": 66.0,
			"size": 26.0, "dmg": 18, "scale": 2.0,
			"tint": Color(1.1, 0.4, 1.4),
			"charge": true,
			"spray": { "count": 9, "dmg": 10, "cd": 3.2 },
			"summon": { "pool": ["vvs_ninja", "vvs_drone"], "count": 2, "cd": 9.0, "max": 6 },
			"credits": 2000,
			"flag": "vvsCleared",
			"drops": ["dragon_slayer"],
			"bark_intro": "VIOLET DRAGON: 'you climbed all this way to die at the top. how thematically appropriate.'",
			"phase2": {
				"name": "LEON TUSK", "sheet": "yakboss", "hp": 130, "speed": 96.0,
				"size": 22.0, "dmg": 22, "scale": 1.7,
				"tint": Color(1.0, 0.85, 0.5),
				"charge": true,
				"spray": { "count": 5, "dmg": 12, "cd": 2.4 },
				"bark_intro": "LEON TUSK: 'the frame was a warm-up. now it's just you and me, ghost.'",
			},
		},
	},
}
