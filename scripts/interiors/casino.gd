...
func _build_people() -> void:
	...
	add_npc("res://assets/sprites/civ/civ-a03.png", Vector3(-8.0, 0.9, -5.6), 3)
	add_npc("res://assets/sprites/civ/civ-b06.png", Vector3(-3.4, 0.9, -5.2), 3)
	add_npc("res://assets/sprites/civ/civ-a10.png", Vector3(5.6, 0.9, -4.9), 3)
